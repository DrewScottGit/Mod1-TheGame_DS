...
const yourScore = document.querySelector('.scoreYou')
const compScore = document.querySelector('.scoreComp')
...
function scoreBoard () {
  if(viewResult.textContent == 'You Lose!'){
    scoreComp++
    compScore.textContent = scoreComp
  }
  if(viewResult.textContent == 'You Win!'){
    scoreYou++
    yourScore.textContent = scoreYou
  }
